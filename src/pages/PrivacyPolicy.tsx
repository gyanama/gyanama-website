        ...
        <div className="container-wide max-w-3xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <div className="not-prose rounded-xl border border-slate-200 bg-white p-5 mb-6">
              ...
              <ul className="text-sm text-slate-700 space-y-1.5 list-disc pl-5">
                <li><strong>Your mobile number</strong> is shared with our SMS gateway provider so it can deliver one-time passwords to your phone.</li>
            ...
            <ul className="list-disc pl-6 text-muted-foreground mb-6 space-y-2">
              ...
              <li><strong>OTP delivery to your phone:</strong> when you request a sign-in OTP, the platform passes your <strong>mobile number and the one-time password</strong> to our SMS gateway sub-processor (see Section 7) so the OTP message can be delivered to that number. The OTP itself is stored only as a one-way hash in our cache and is automatically removed after 5 minutes.</li>
